...
public class PersonsControllerTest {
    ...
    void getAllPersonsReturnsAllPersons() throws Exception {
        ...
        given(personsService.findAll()).willReturn(DummyPersonBuilder.buildPerson(expectedNumberOfPersons));
    ...
    void getPersonResponseIsOk() throws Exception {
        given(personsService.findById(anyLong())).willReturn(Optional.of(DummyPersonBuilder.buildPerson()));
    ...
    void getMatchingPersonsReturnsCorrectNumberOfPersons() throws Exception {
        Integer expectedNumberOfPersons = 5;
        given(personsService.findByColor(any())).willReturn(DummyPersonBuilder.buildPerson(expectedNumberOfPersons));
